...
urlpatterns = [
    ...
    path('contact-voki/', Contact_model_view.as_view(), name='contact_page'),
    ...
    path('team-voki/', TeamPageView.as_view(), name='team'),
    path('stage/', StagePageView.as_view(), name='stage'),
    path('custom-software/', CustSoftPageView.as_view(), name='stage'),
